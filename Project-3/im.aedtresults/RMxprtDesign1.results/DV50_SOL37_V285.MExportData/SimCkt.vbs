...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  ...
  "Id:=", "9"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.09144, "Y:=", _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  ...
  Array("NAME:VALUE", "OverridingDef:=", true, "Value:=", "1549.36rpm"))))
...
oEditor.CreateGround Array("NAME:GroundProps", "Id:=", "1"), Array(_
  ...
  "Degrees:=", 0, "Flip:=", false) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Measurement/Electrical:AM", "Id:=", "12"), _
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Measurement/Electrical:AM", "Id:=", "13"), _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PropDisplayPropTab", _
  ...
  Array("NAME:InstanceName", "Format:=", "Value", "Location:=", "Right"))))
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Measurement/Electrical:AM", "Id:=", "14"), _
...
oEditor.CreatePagePort Array("NAME:PagePortProps", "Name:=", "N", "Id:=", 18), _
  ...
  0, "Flip:=", false) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Measurement/Electrical:VM", "Id:=", "19"), _
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Circuit/Sources:E", "Id:=", "20"), _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  ...
  "NAME:AMPL", "OverridingDef:=", true, "Value:=", "1102.27V"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;20;0"), Array("NAME:ChangedProps", Array(_
  "NAME:FREQ", "OverridingDef:=", true, "Value:=", "78Hz"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;20;0"), Array("NAME:ChangedProps", Array(_
  "NAME:TPERIO", "OverridingDef:=", true, "Value:=", "0.0128205s"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Quantities", Array(_
  "NAME:PropServers", "CompInst@E;20;0"), Array("NAME:ChangedProps", Array(_
...
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
  ...
  "Page:=", 1) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Circuit/Sources:E", "Id:=", "21"), _
...
oEditor.CreateWire Array("NAME:WireData", "Id:=", "1", "Points:=", Array(_
  ...
  "Page:=", 1) 
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", _
  "Simplorer Elements/Basic Elements/Circuit/Sources:E", "Id:=", "22"), _
